System.register(['angular2/core', 'app/components/input_component/input.component'], function(exports_1, context_1) {
    ...
    var InputEventKeyDownComponent;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
        ...
        execute: function() {
            InputEventKeyDownComponent = (function () {
                function InputEventKeyDownComponent() {
                    this.characters = "";
                }
                ...
                ], InputEventKeyDownComponent);
                return InputEventKeyDownComponent;
            }());
            exports_1("InputEventKeyDownComponent", InputEventKeyDownComponent);
        }
    }
});
//# sourceMappingURL=input.event.keydown.component.js.map